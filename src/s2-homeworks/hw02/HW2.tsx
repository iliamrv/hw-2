...
export const filterAffairs = (
  ...
  let filtered = affairs.filter((el) => el.priority === filter);
...
export const deleteAffair = (
  ...
  // ??? need to fix any
  const filteredAffais = affairs.filter((t) => t._id !== _id);
  return filteredAffais;
...
function HW2() {
  ...
  const deleteAffairCallback = (_id: number) => {
    ...
    //let deletedTasks = affairs.filter((t) => t._id !== _id);

    //  setAffairs(deletedTasks);
  };
